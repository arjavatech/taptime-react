...
const Login = () => {
  ...
  // Clear companyID from localStorage when login page loads (skip during OAuth callback)
  useEffect(() => {
    const isOAuthCallback = new URLSearchParams(window.location.search).get('code');
    if (!isOAuthCallback) {
