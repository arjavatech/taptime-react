      ...
      <section className="flex-grow bg-gray-50 px-4 sm:px-6 pt-25 pb-16">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
            {/* Contact Info */}
            <div className="flex">
              <div className="bg-white rounded-lg shadow-sm border p-4 sm:p-6 lg:p-8 flex-1 flex flex-col">
                ...
                <div className="space-y-4 sm:space-y-6 flex-grow">
                  <div className="flex items-center space-x-3 sm:space-x-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:contact@tap-time.com" className="text-sm sm:text-base text-[#02066F] hover:underline break-all">
                  ...
                  <div className="flex items-center space-x-3 sm:space-x-4">
                    ...
                    <div>
                      <h3 className="text-sm sm:text-base font-semibold text-gray-900">Support Hours</h3>
                  ...
                  <div className="flex items-center space-x-3 sm:space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm sm:text-base text-gray-600">123 Business Ave, Suite 100<br />New York, NY 10001</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* Contact Form */}
            <div className="flex">
              <div className="bg-white rounded-lg shadow-sm border p-4 sm:p-6 lg:p-8 flex-1">
                <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-4 sm:mb-6">Send Message</h2>
                ...
                <form className="space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
                  ...
                  <button
                    ...
                    className="w-full bg-[#02066F] text-white py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg text-sm sm:text-base font-medium hover:bg-[#030974] focus:ring-2 focus:ring-[#02066F] focus:ring-offset-2 disabled:opacity-50 transition-colors"
                  >
                    {showOverlay ? (
