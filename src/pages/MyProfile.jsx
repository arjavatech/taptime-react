...
const MyProfile = () => {
  ...
  return <><Header /><main className="max-w-3xl mx-auto px-4 pt-28 pb-10">
    <Card><CardHeader><CardTitle>My Profile</CardTitle></CardHeader><CardContent className="space-y-6">
      {!profile ? <p>Loading profile…</p> : <div className="grid sm:grid-cols-2 gap-4 text-sm">
      ...
      <form onSubmit={savePin} className="border-t pt-6 max-w-sm space-y-3">
