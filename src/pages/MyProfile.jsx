...
const MyProfile = () => {
  ...
  const companyName = profile.company_name || localStorage.getItem('companyName') || '—';
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:gap-4">
                  ...
                  <div className="min-w-0 pb-1">
                    ...
                    <div className="mt-1 flex flex-wrap items-center gap-2">
                      <h2 className="break-words text-xl font-bold tracking-tight  sm:text-white sm:text-3xl text-slate-900">
          ...
          <div className="mt-4 grid gap-4 sm:mt-6 sm:gap-6 md:grid-cols-2">
            ...
            <section className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:rounded-2xl sm:p-6">
              ...
              <div className="mt-5 space-y-4">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {editingPin ? (
                      <form onSubmit={savePin} className="mt-1 flex items-center gap-2">
                        <div className="relative flex items-center">
                          <input
                            ...
                            className="w-28 rounded-lg border border-slate-300 px-2 py-1 pr-7 font-mono text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#01005a]"
                          />
                          <button type="button" onClick={() => setShowPin((v) => !v)} className="absolute right-1.5 text-slate-400 hover:text-slate-600">
                      ...
                      <div className="mt-0.5 flex items-center gap-2">
                        <p className="font-mono text-sm font-medium tracking-wide text-slate-800">
                          {showPin ? (profile.pin || pin || '—') : '••••'}
                        </p>
                        <button type="button" onClick={() => setShowPin((v) => !v)} className="text-slate-400 hover:text-slate-600">
                          {showPin ? <EyeOff className="h-3.5 w-3.5" /> : <Eye className="h-3.5 w-3.5" />}
                        </button>
                ...
                <DetailRow icon={Building2} label="Company Name" value={companyName} mono />
              </div>
            </section>
          </div>
        </div>
