...
const Register = () => {
  ...
  const renderStep1 = () => (
    <Card className="border-0 shadow-xl sm:shadow-2xl">
      <CardHeader className="space-y-1 text-center bg-primary text-primary-foreground rounded-t-xl px-4 sm:px-6 py-4 sm:py-6">
        <CardTitle className="text-xl sm:text-2xl font-bold">Company Information</CardTitle>
    ...
    <>
      ...
      {toast.show && (
        <div className="fixed top-20 sm:top-24 right-4 left-4 sm:left-auto sm:right-4 z-50 animate-in slide-in-from-top-2">
          <div className={`flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg shadow-lg border ${toast.type === 'success'
        ...
        <div className="w-full md:w-1/2 bg-gradient-to-br from-primary/5 via-background to-secondary/5 flex items-center justify-center py-8 sm:py-12 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 md:min-h-screen">
          <div className="w-full max-w-md">
            ...
            <div className="flex items-center space-x-3 sm:space-x-4">
              <div className={`w-7 h-7 sm:w-8 sm:h-8 rounded-full flex items-center justify-center text-xs sm:text-sm font-medium ${currentStep >= 1 ? 'bg-primary text-primary-foreground' : 'bg-muted text-muted-foreground'
                }`}>
                1
              </div>
              <div className={`w-12 sm:w-16 h-1 rounded ${currentStep >= 2 ? 'bg-primary' : 'bg-muted'
                }`} />
              <div className={`w-7 h-7 sm:w-8 sm:h-8 rounded-full flex items-center justify-center text-xs sm:text-sm font-medium ${currentStep >= 2 ? 'bg-primary text-primary-foreground' : 'bg-muted text-muted-foreground'
                }`}>
                2
              </div>
            </div>
